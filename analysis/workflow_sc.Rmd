...
![ ](assets/workflows/percentmt-1.png)
...
![ ](assets/workflows/nCount&nFeature-1.png)
...
![ ](assets/workflows/Processing1-1.png)

```{r Processing3, eval=F}
VizDimLoadings(seu, dims=1:2)
```

![ ](assets/workflows/Processing1-2.png)
...
![ ](assets/workflows/Processing1-3.png)
...
![ ](assets/workflows/ClusteringAndVis-1.png)
...
![ ](assets/workflows/Annotation-1.png)
...
![ ](assets/workflows/Visualisewithnewannotations-1.png)
